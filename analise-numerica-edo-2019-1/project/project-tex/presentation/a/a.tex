...
\title{Metódos Númericos para o problema dos N-Corpos} %% that will be typeset on the
\subtitle{Integradores Simpléticos} %% title page.
\author{Gil Sases M.ssdd Neto}
