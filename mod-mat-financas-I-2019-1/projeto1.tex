...
\makeatother
  ...
  % ---
  \titulo{Projeto I\\Modelagem Matemática em Finanças I \\O Modelo Binomial}
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Função para simular os valores da ação dados os parametros}
...
{In [2]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Definição dos parametros}
         \PY{n}{T} \PY{o}{=} \PY{l+m+mi}{20}
         \PY{n}{dt} \PY{o}{=} \PY{l+m+mf}{0.5}
         \PY{n}{S0} \PY{o}{=} \PY{l+m+mi}{8}
         \PY{n}{u} \PY{o}{=} \PY{l+m+mf}{1.1}
         \PY{n}{d} \PY{o}{=} \PY{l+m+mf}{0.8}
         \PY{n}{p} \PY{o}{=} \PY{l+m+mf}{0.65}
...
\begin{Verbatim}[breaklines=true,commandchars=\\\{\}]
{In [3]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{20}\PY{p}{)}\PY{p}{:}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{vs} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{med\PYZus{}1} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{vf} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{250}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{,}\PY{l+m+mi}{1000}\PY{p}{,}\PY{l+m+mi}{2000}\PY{p}{]}\PY{p}{:}
            \PY{n}{vs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{p}{[}\PY{n}{binomial}\PY{p}{(}\PY{n}{S0}\PY{p}{,} \PY{n}{T}\PY{p}{,} \PY{n}{dt}\PY{p}{,} \PY{n}{u}\PY{p}{,} \PY{n}{d}\PY{p}{,} \PY{n}{p}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{j}\PY{p}{)}\PY{p}{]}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{boxplot}\PY{p}{(}\PY{n}{vs}\PY{p}{,}\PY{n}{showfliers}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}83}]:} \PY{n}{u\PYZus{}n} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{u}\PY{p}{)}
         ...
         \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{250}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{,}\PY{l+m+mi}{1000}\PY{p}{,}\PY{l+m+mi}{2000}\PY{p}{]}\PY{p}{:}
             \PY{n}{vs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{p}{[}\PY{n}{binomial}\PY{p}{(}\PY{n}{S0}\PY{p}{,} \PY{n}{T}\PY{p}{,} \PY{n}{dt\PYZus{}n}\PY{p}{,} \PY{n}{u\PYZus{}n}\PY{p}{,} \PY{n}{d\PYZus{}n}\PY{p}{,} \PY{n}{p}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{j}\PY{p}{)}\PY{p}{]}\PY{p}{)}
...
\subsection{Plot com escala comum}
  \begin{figure}[h]
    \hspace*{-2cm}
    \adjustimage{max size={1.2\linewidth}{1.3\paperheight}}{fig1.png}
  \end{figure}
\subsection{Plot com escala log}
\begin{figure}[h]
  \hspace*{-2cm}
  \adjustimage{max size={1.2\linewidth}{1.3\paperheight}}{fig2.png}
\end{figure}
